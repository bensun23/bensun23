...
- 🐍 Strong interest in **Python programming** and problem-solving
- 🚦 Currently working on **Multi-Agent Traffic Signal Optimization using Deep Reinforcement Learning**
- 📊 Skilled in building projects involving **data, simulations, and AI models**
- 🧠 Continuously learning and exploring **AI/ML, automation, and real-world problem solving**
- 🔧 Experience with **Flask, SUMO, Git, and basic web technologies**
- 🎯 Goal: To become a **Machine Learning Engineer / Data Scientist**
